  ...
  <body>
        <nav id="mainNav" class="clearfix">
              <div id="logoPlaceholder">
                    <a href="index.php">
                      	<img src="images/portfolio-logo.svg" alt="Justin Fester | Web Designer | Graphic Designer" id="siteLogo">
                    </a>
              </div>
        ...
        <section id="about">
              <div id="aboutPlacement" class="clearfix">
                    ...
                    <section id="aboutNavigate">
                          ...
                          <div class="aboutNavigateButton needs button">
                            <p><a href="needsAnalysis.php">Needs Analysis</a></p>
                          </div>
        ...
        <section id="contact">
              <div id="contactPlacement">
                    <h1>Contact</h1>
                    <form action="contact-mailscript.php" method="post" id="contactForm">
                          <input type="text" name="Name" id="userName" placeholder="Your Name">
                          <input type="email" name="email" id="email" placeholder="E-mail Address">
                          <textarea name="comment" id="comment" rows="6" placeholder="Type your message here"></textarea>
                          <input type="submit" id="formSubmitButton"  class="button" value="Submit">
                    </form>
            
                    <section id="contactInfo">
                          <h2>Contact Details</h2>
                          <p>Tel: <a href="tel:0768471336">076 847 1336</a></p>
